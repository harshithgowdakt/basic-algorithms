...
function verticalOrder(root, vertices = 0, result = {}) {
    if (root === null) {
        return;
    }
    ...
    result[vertices].push(root.data);
    verticalOrder(root.left, vertices - 1, result);
    verticalOrder(root.right, vertices + 1, result);
}
