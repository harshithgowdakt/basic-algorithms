...
19      30      21      40
Object.values(bottomView).reverse()
 */


function bottomViewOfBinaryTree(root) {
    let bottomView = {}, queue = [];
    if (root === null) {
        return bottomView;
    }
...
function main() {
    ...
    let bottomView = bottomViewOfBinaryTree(root);
    console.log(Object.values(bottomView));
